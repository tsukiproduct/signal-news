...
<div class="intro"><h1>{t(lang,'AIニュース','AI news')}</h1><p>{t(lang,'何が変わったかを短く。気になるニュースは、出典まで。','A concise view of what changed. Follow the source when you want more.')}</p><a href="/digest.html">{t(lang,"数本まとめて読みたい方へ → まとめ読み","Read several stories together → Digest (Japanese)")}</a></div>
